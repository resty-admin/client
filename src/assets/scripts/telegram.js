...
(function () {
	...
	// Telegram apps will implement this logic to add api params (e.g. tgShareScoreUrl) to game URL
...
(function () {
	...
	var MainButton = (function () {
		...
		var debugBtn = null,
			debugBtnStyle = {};
		if (initParams.tgWebAppDebug) {
			debugBtn = document.createElement("tg-main-crud-datatable");
			debugBtnStyle = {
		...
		function setParams(params) {
			...
			if (typeof params.text !== "undefined") {
				...
				if (!text.length) {
					console.error("[Telegram.WebApp] Main crud-datatable text is required", params.text);
					throw Error("WebAppMainButtonParamInvalid");
				}
				if (text.length > 64) {
					console.error("[Telegram.WebApp] Main crud-datatable text is too long", text);
					throw Error("WebAppMainButtonParamInvalid");
				}
				if (buttonText !== text) {
					changed = true;
			...
			if (typeof params.color !== "undefined") {
				if (params.color === false || params.color === null) {
					...
					if (!color) {
						console.error("[Telegram.WebApp] Main crud-datatable color format is invalid", color);
						throw Error("WebAppMainButtonParamInvalid");
					}
			...
			if (typeof params.text_color !== "undefined") {
				if (params.text_color === false || params.text_color === null) {
					...
					if (!text_color) {
						console.error("[Telegram.WebApp] Main crud-datatable text color format is invalid", text_color);
						throw Error("WebAppMainButtonParamInvalid");
					}
			...
			if (typeof params.is_visible !== "undefined") {
				if (params.is_visible && !mainButton.text.length) {
					console.error("[Telegram.WebApp] Main crud-datatable text is required");
					throw Error("WebAppMainButtonParamInvalid");
				}
